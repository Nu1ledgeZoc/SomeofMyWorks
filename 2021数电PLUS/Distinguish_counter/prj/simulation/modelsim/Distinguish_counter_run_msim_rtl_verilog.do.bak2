...
vlog -vlog01compat -work work +incdir+D:/ProjectCode/FPGA/Distinguish_counter/verilog {D:/ProjectCode/FPGA/Distinguish_counter/verilog/Distinguish_counter.v}

vlog -vlog01compat -work work +incdir+D:/ProjectCode/FPGA/Distinguish_counter/prj/../sim {D:/ProjectCode/FPGA/Distinguish_counter/prj/../sim/tb_Distinguish_counter.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  tb_Distinguish_counter
